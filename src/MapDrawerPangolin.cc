...
namespace ORB_SLAM3
{
    ...
    MapDrawerPangolin::MapDrawerPangolin()
    {

    }

    void MapDrawerPangolin::Init(Atlas* pAtlas, const string& strSettingPath, Settings* settings)
    {
        this->mpAtlas = pAtlas;
    ...
    void MapDrawerPangolin::newParameterLoader(Settings* settings) {
    ...
    bool MapDrawerPangolin::ParseViewerParamFile(cv::FileStorage& fSettings)
    {
    ...
    void MapDrawerPangolin::DrawMapPoints()
    {
    ...
    void MapDrawerPangolin::DrawKeyFrames(const bool bDrawKF, const bool bDrawGraph, const bool bDrawInertialGraph, const bool bDrawOptLba)
    {
    ...
    void MapDrawerPangolin::DrawCurrentCamera(pangolin::OpenGlMatrix& Twc)
    {
    ...
    void MapDrawerPangolin::SetCurrentCameraPose(const Sophus::SE3f& Tcw)
    {
        unique_lock<mutex> lock(mMutexCamera);
        mCameraPose = Tcw.inverse();
    }

    void MapDrawerPangolin::SetReferenceKeyFrame(KeyFrame* pKF)
    {
    }

    void MapDrawerPangolin::GetCurrentOpenGLCameraMatrix(pangolin::OpenGlMatrix& M, pangolin::OpenGlMatrix& MOw)
    {
        Eigen::Matrix4f Twc;
        {
            unique_lock<mutex> lock(mMutexCamera);
    ...
    Atlas* MapDrawerPangolin::GetAtlas()
    {
        return this->mpAtlas;
    }
} //namespace ORB_SLAM
